...
<task>
    ...
    # <source_star>
    # <source_starfield>
    <source_background nr_photons = "1293"> "bg source path" 123,3 43 45.2
    # <source_laser>
    ...
    <conv_vel> 3984
    <mass_fraction> 349
    <mrw> 45			## Should generate a Warning
    <pda> 63			## Should generate a Warning
    <dust_offset> 0
    <dust_gas_coupling> 0
    <radiation_field> 39
    <rt_scattering> 948
    <split_dust_emission> 23.4
    <full_dust_temp> 123
    ...
    <plot_inp_midplanes> 23
    <plot_out_midplanes> 43
...
<task>
    ...
    <dust_offset min_gas_density="23.45"> 48.4
    <dust_gas_coupling min_gas_density = "34,34"> 23.5
...
<task>
    ...
    <gas_species> "Path to gas" POP_DEGUCHI_LVG 43.54
    <align> ALIG_PA
    <nr_threads> 100203
</task>
